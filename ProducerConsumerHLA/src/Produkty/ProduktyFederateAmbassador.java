...
public class ProduktyFederateAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                   INSTANCE VARIABLES
	//----------------------------------------------------------
	private ProduktyFederate federate;
	...
	public ProduktyFederateAmbassador(ProduktyFederate federate )
	{
...
//			if( attributeHandle.equals(federate.queueNumberOfProductsForClientAHandle) )
//			{
//				builder.append( attributeHandle );
...
//
	    ...
	    throws FederateInternalError
	{
		...
		if( interactionClass.equals(federate.addProductsForClientHandle) )
		{
			builder.append( " (addProductsForClientHandle)" );
		}
