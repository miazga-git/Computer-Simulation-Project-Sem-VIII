...
public class KasyFederateAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public KasyFederateAmbassador(KasyFederate federate )
	{
...
//			}
			else if( attributeHandle.equals(federate.queueMaxNumberOfClientsHandle) )
			{
				...
				builder.append( max.getValue() );
				federate.queueMaxNumberOfClients= max.getValue();
			}
			else
			{
				builder.append( attributeHandle );
