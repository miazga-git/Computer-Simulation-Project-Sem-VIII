...
public class StatystykiFederate
{
    ...
    public Statystyki stats = new Statystyki();
    ...
    public void runFederate( String federateName ) throws Exception
    {
        ...
        rtiamb.joinFederationExecution( federateName,            // name for the federate
                "statystyki",   // federate type //nazwa typu
        ...
        while( fedamb.isRunning )
        {
           ...
           // stats.wypiszStatystyki(queueInfoNumberOfClientsInQueueA,queueInfoNumberOfClientsInQueueB);
            // 9.3 request a time advance and wait until we get it
            advanceTime(stats.getTimeToNext());
    ...
    private void publishAndSubscribe() throws RTIexception
    {
        ...
        //w przypadku subskrypcji to może tylko być problem z ilością produktów
    }
    /**
